...
class RoutePlanner:
    ...
    def find_shortest_route(self, preference):
        # Build graph
        self.build_graph(preference)

        # Use traveling_salesman_problem from NetworkX to find the shortest path
        tsp_path = nx.approximation.traveling_salesman_problem(self.graph, cycle=True, weight="distance")
        
        # Ensure it ends back at the start node
